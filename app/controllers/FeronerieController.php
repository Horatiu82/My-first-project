...
class FeronerieController extends AppController
{
    ...
    public function init()
    {
        ...
        if (isset($_SESSION['user'])) {
            $data['title'] = 'Feronerie';
            $data['mainContent'] = "<h1 class='display-3 text-info'> Feronerie KariPlast</h1>
      <div class='feronerieKari '>
        <div class='card bg-secondary' style='width: 20rem;'>
          <img class='card-img-top' src='app/images/feronerie/feronerie1.png' alt='feronerie1'>
         <div class='card-body'>
         ...
         <div class='card bg-secondary' style='width: 20rem;'>
         <img class='card-img-top' src='app/images/feronerie/feronerie2.png' alt='feronerie2'>
         <div class='card-body'>
         <p class='card-text text-light'>Some quick example text to build on the card title and make up the bulk of the card's content.</p>
        </div>
      </div>
     ...
     <div class='card bg-secondary' style='width: 20rem;'>
     <img class='card-img-top' src='app/images/feronerie/feronerie3.png' alt='feronerie3'>
     <div class='card-body'>
     <p class='card-text text-light'>Some quick example text to build on the card title and make up the bulk of the card's content.</p>
     </div>
     </div>
     ...
     <div class='card bg-secondary' style='width: 20rem'>
     <img class='card-img-top' src='app/images/feronerie/feronerie4.png' alt='feronerie4'>
     <div class='card-body'>
     <p class='card-text text-light'>Some quick example text to build on the card title and make up the bulk of the card's content.</p>
     </div>
     </div>
     ...
     <div class='card bg-secondary' style='width: 20rem'>
     <img class='card-img-top' src='app/images/feronerie/feronerie5.png' alt='feronerie5'>
     <div class='card-body'>
     <p class='card-text text-light'>Some quick example text to build on the card title and make up the bulk of the card's content.</p>
     </div>
     </div>
            ...
            $data['title'] = 'Feronerie';
            $data['mainContent'] =
                "<h1 class='display-3 text-info'> Feronerie KariPlast</h1>
