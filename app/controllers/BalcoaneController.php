...
class BalcoaneController extends AppController
{
    ...
    public function init()
    {
        ...
        if (isset($_SESSION['user'])) {
            ...
            <h3 class='display-4 text-info ms-2'> Balcoane KariPlast</h3>
            <img class='pozeBalcoane' src='app/images/balcoane/balcon1.png' alt='balcon1'>
            <button class='butonBal'>Next image</button>";
            echo $this->render(APP_PATH . VIEWS . 'layoutAuth.html', $data);
        } else {
            $data['title'] = 'Balcoane';
            $data['mainContent'] =
                "<h1 class='display-3 text-info'> Balcoane KariPlast</h1>
