...
class BlocuriController extends AppController
{
    ...
    public function init()
    {
        ...
        if (isset($_SESSION['user'])) {
            $data['title'] = 'Blocuri';
            $data['mainContent'] = "
            <h3 class='display-4 text-info ms-2'> Blocuri KariPlast</h3>
            <img class='pozeBloc' src='app/images/blocuri/bloc1.png' alt='bloc1'>
            <button class='butonBloc'>Next image</button>
            ";
            echo $this->render(APP_PATH . VIEWS . 'layoutAuth.html', $data);
        } else {
            $data['title'] = 'Blocuri';
            $data['mainContent'] =
                "<h1 class='display-3 text-info'> Blocuri KariPlast</h1>
