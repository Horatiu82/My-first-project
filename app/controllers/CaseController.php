...
class CaseController extends AppController
{
    ...
    public function init()
    {
        ...
        <h3 class='display-4 text-info ms-2'> Case KariPlast</h3>
         <img class='pozeCase' src='app/images/case/casa1.jpeg' alt='casa1'>
        <button class='btnCase'>Next image</button>";
            echo $this->render(APP_PATH . VIEWS . 'layoutAuth.html', $data);
        } else {
            $data['title'] = 'Case';
            $data['mainContent'] = "
            <h1 class='display-3 text-info'> Case KariPlast</h1>
