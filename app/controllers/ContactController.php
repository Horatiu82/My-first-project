...
class ContactController extends AppController
{
    ...
    public function init()
    {
        ...
        if (isset($_SESSION['user'])) {
            $data['title'] = 'Contact';
            $data['mainContent'] = "<h3 class='display-4 text-info ms-2'> Contact KariPlast</h3>
            <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Iste pariatur dolor repudiandae dignissimos labore non reprehenderit magnam voluptatem obcaecati repellat, minus ab unde ea aperiam eligendi doloremque blanditiis nam explicabo!
Odit dolorem cumque necessitatibus beatae amet! Nam iure fugiat modi, fuga animi quo amet ab culpa quos, aperiam optio, cum corporis aliquam omnis asperiores. Enim id repudiandae dolorum voluptatibus et?</p>
            ...
            $data['title'] = 'Contact';
            $data['mainContent'] =
                "<h1 class='display-3 text-info'> Contact KariPlast</h1>
