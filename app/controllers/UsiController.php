...
<?php
class UsiController extends AppController
{
  ...
  public function init()
  {
    ...
    if (isset($_SESSION['user'])) {
      $data['title'] = 'Usi';
      $data['mainContent'] = "<h1 class='display-3 text-info'> Usi KariPlast</h1>
      <div class='usiKari '>
        <div class='card bg-secondary' style='width: 20rem;'>
          <img class='card-img-top' src='app/images/usi/usa01.png' alt='usa01'>
         <div class='card-body'>
         ...
         <div class='card bg-secondary' style='width: 20rem;'>
         <img class='card-img-top' src='app/images/usi/usa02.png' alt='usa02'>
         <div class='card-body'>
         <p class='card-text text-light'>Some quick example text to build on the card title and make up the bulk of the card's content.</p>
        </div>
      </div>
     ...
     <div class='card bg-secondary' style='width: 20rem;'>
     <img class='card-img-top' src='app/images/usi/usa03.png' alt='usa03'>
     <div class='card-body'>
     <p class='card-text text-light'>Some quick example text to build on the card title and make up the bulk of the card's content.</p>
     </div>
     </div>
     ...
     <div class='card bg-secondary' style='width: 20rem'>
     <img class='card-img-top' src='app/images/usi/usa04.png' alt='usa04'>
     <div class='card-body'>
     <p class='card-text text-light'>Some quick example text to build on the card title and make up the bulk of the card's content.</p>
     </div>
     </div>
     ...
     <div class='card bg-secondary' style='width: 20rem'>
     <img class='card-img-top' src='app/images/usi/usa05.png' alt='usa05'>
     <div class='card-body'>
     <p class='card-text text-light'>Some quick example text to build on the card title and make up the bulk of the card's content.</p>
     </div>
     </div>
